...
func runCLI(args []string) (output any) {
	...
	} else if has(stringsA("prepare", "resume", "open", "lesson", "sync"), cmd) && str(o["root"]) == "" && selectedLanguage() == "ja" {
		return runJapanese(args, commands, o)
	}
